...
To use [`ggauto()`](https://nrennie.rbind.io/ggauto/reference/ggauto.md)
simply pass in the data and the variable names you wish to visualise.
For example, using the `mpg` data from `ggplot2`:
