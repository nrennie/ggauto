...
[![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/ggauto)](https://cran.r-project.org/package=ggauto)
<!-- badges: end -->
...
To use `ggauto()` simply pass in the data and the variable names you
wish to visualise. For example, using the `mpg` data from `ggplot2`:
...
See the [Examples
vignette](https://nrennie.rbind.io/ggauto/articles/Examples.html) for
more information, including different chart types, how to edit chart
text, and different ways to pass in data.
