...
See the [Examples vignette](https://nrennie.rbind.io/ggauto/articles/Examples.html) for more information, including different chart types, how to edit chart text, and different ways to pass in data.
